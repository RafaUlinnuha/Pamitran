        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mt-4 content">
                    <h1 class="title">CONFERENCE ROOM</h1>
                </div>
                <img src="<?= base_url('assets/img/layanan/foto 10-1.png') ?>" class="image_1">
                <img src="<?= base_url('assets/img/layanan/foto 10.png') ?>" class="image_2">
            </div>
        </div>
    </section>
