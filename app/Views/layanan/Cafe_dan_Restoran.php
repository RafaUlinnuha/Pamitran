        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12 mt-4 content">
                    <h1 class="title">CAFE DAN RESTORAN</h1>
                    <div class="layanan_text row pt-3">
                        <p>Cafe dan restoran merupakan fasilitas umum yang disediakan PAMITRAN – UP untuk memudahkan karyawan atau pengunjung untuk beristirahat dan membeli makanan/minuman.</p>
                    </div>
                </div>
            </div>
        </div>
