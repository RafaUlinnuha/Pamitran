        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mt-4 content">
                    <h1 class="title">DENTAL TRAINING CENTER</h1>
                </div>
                <img src="<?= base_url('assets/img/layanan/foto 13-1.png') ?>" class="image_1">
                <img src="<?= base_url('assets/img/layanan/foto 13.png') ?>" class="image_2">
            </div>
        </div>
    </section>
