        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12 mt-4 content">
                    <h1 class="title">LABORATORIUM</h1>
                    <div class="layanan_text row pt-3">
                        <p>Tersedianya tempat aktivitas ilmiah civitas akademika untuk melakukan percobaan/eksperimen, penelitian/riset, observasi, demontrasi yang terkait dalam kegiatan belajar-mengajar di lingkungan PAMITRAN – UP.</p>
                    </div>
                </div>
            </div>
        </div>
